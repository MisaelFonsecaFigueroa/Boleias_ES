<div class="p-6 sm:px-20 bg-white border-b border-gray-900">
    <div class="flex">
        <x-jet-application-logo class="block h-12 w-auto p-4"/>
        <span class="inline-block font-semibold ml-4 font-sans text-4xl align-baseline">BOLEIAS</span>
    </div>
